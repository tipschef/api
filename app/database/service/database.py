...
SQLALCHEMY_DATABASE_URL = f'mysql+pymysql://{secret_content.get("mysql_account")}:{secret_content.get("mysql_password")}@{secret_content.get("mysql_hostname")}:{secret_content.get("mysql_port")}/{DATABASE_NAME}'
